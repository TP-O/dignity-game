                ...
                <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px;">
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">Tap the button below to confirm your email address. If you didn't
                                create an account with <a href="#">Dignity Game</a>, you can safely delete
                                this email.</p>
                        </td>
                    </tr>
                    <!-- end copy -->
                    ...
                    <tr>
                        <td align="left" bgcolor="#ffffff"
                            ...
                            <p style="margin: 0;">Cheers,<br> Dignity Game</p>
                        </td>
                    </tr>
                    <!-- end copy -->
                    ...
                    <tr>
                        <td align="center" bgcolor="#e9ecef"
                            ...
                            <p style="margin: 0;">You received this email because we received a request for
                                resetting for your password. If you didn't request resetting account you can safely
                                delete this email.</p>
                        </td>
                    </tr>
                    <!-- end permission -->
                    ...
                    <tr>
                        <td align="center" bgcolor="#e9ecef"
                            ...
                            <p style="margin: 0;">To stop receiving these emails, you can <a
                                    href="#" target="_blank">unsubscribe</a> at any time.</p>
                            <p style="margin: 0;">Dignity Game 1234 S. Broadway St. City, State 12345</p>
                        </td>
                    </tr>
                    <!-- end unsubscribe -->
...
type resetPasswordInjection struct {
	Link string
}

func (m mailer) SendResetPasswordEmail(to, link string) (err error) {
	var (
		msg  *gomail.Message
		body bytes.Buffer
	...
	tmpl, err = template.New("reset_password_email").Parse(resetPasswordTemplate)
	if err != nil {
		return
	}

	err = tmpl.Execute(&body, resetPasswordInjection{Link: link})
	if err != nil {
		return
	}
	...
	msg.SetHeader("To", to)
	msg.SetHeader("Subject", "Dignity Game Reset Password")
