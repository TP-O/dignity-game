                    ...
                    <tr>
                        <td align="center" bgcolor="#e9ecef"
                            ...
                            <p style="margin: 0;">You received this email because we received a request for
                                verifying for your account. If you didn't request verifying account you can safely
                                delete this email.</p>
                        </td>
                    </tr>
                    <!-- end permission -->
...
type verifyEmailInjection struct {
	Link string
}

func (m mailer) SendEmailVerificationEmail(to, link string) (err error) {
	var (
		msg  *gomail.Message
		body bytes.Buffer
